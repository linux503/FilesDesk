const I18N = {
  zh: {
    ...
    download: {
      ...
      source: "GitHub 源码",
      afterTitle: "安装后",
      after: "打开磁盘映像，将 FilesDesk 拖入「应用程序」，添加文件或文件夹即可开始。应用会通过 Sparkle 从此站点检查更新。",
      reqTitle: "系统要求",
  ...
  en: {
    ...
    download: {
      ...
      after: "Open the disk image, drag FilesDesk to Applications, then add files or a folder. Updates are checked via Sparkle from this site.",
